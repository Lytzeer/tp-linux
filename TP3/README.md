...
🌞 Vous fournirez dans le compte-rendu, en plus du fichier, **un exemple d'exécution avec une sortie**, dans des balises de code.
```
[lukas@tp3 yt]$ ./yt.sh https://www.youtube.com/watch?v=umDr0mPuyQc
Video https://www.youtube.com/watch?v=umDr0mPuyQc was downloaded.
File path : /srv/yt/downloads/NO_GOD!_PLEASE_NO!!!_NOOOOOOOOOO/NO_GOD!_PLEASE_NO!!!_NOOOOOOOOOO.mp4
```
